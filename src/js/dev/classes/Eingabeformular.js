...
/**
 * Die Klasse "Eingabeformular" stellt alle Eingenschaften
 * und Methoden des Eingabeformulars (inkl. HTML und Events) zur Verfügung.
 */
export default class Eingabeformular {

    /**
     * Der Konstruktor generiert bei Instanziirung der Klasse "Eingabeformular"
     ...
     * @param {Event} submit_event - das Submit-Event das Eingabeformular 
     ...
     * @returns {Object} - einfaches Objekt mit den verarbeiteten Formulardaten
     */
    ...
    /**
     * Die private Methode validiert die durch this._formulardaten_verarbeiten() zur Verfügung gestellten Formulardaten.
     * @param {Objekt} formulardaten - einfaches Objekt mit den verarbeiteten Formulardaten
     * @returns {Array} - ein Array mit den Namen der Eingabefelder für die Validierungsfehler gefunden wurden
     */
    ...
    /**
     * Diese private Methode aktualisiert das Datum des Date-Inputs im Eingabeformular (z.B. beim öffenen der Seite
     ...
     * @param {Element} eingabeformular - das Eingabeformular-Element, für welches das Submit-Event hinzufügt wird
     */
